...
class AdminPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->widgets([
                \App\Filament\Widgets\EtlProgressWidget::class,
                \App\Filament\Widgets\CategoryTreemapWidget::class,
            ])
            ->middleware([
            ...
            ->authMiddleware([
                // Autenticação desativada para uso portátil monousuário local
            ]);
    }
}
